...
2. Ищите по названию или ингредиенту. Категории, **Все рецепты** и **Любимые** переключают разделы, не оставляя скрытого ограничения на избранное. Дополнительные фильтры находятся в кнопке **Фильтры**. Крестик в строке поиска очищает запрос.
