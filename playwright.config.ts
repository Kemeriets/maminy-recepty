...
export default defineConfig({
  ...
  webServer: process.env.PLAYWRIGHT_BASE_URL ? undefined : { command: "npm run dev:portable -- --host 127.0.0.1 --port 4173", url: "http://127.0.0.1:4173", reuseExistingServer: true, timeout: 120_000 },
});
