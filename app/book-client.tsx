...
function storageStatus(state: SyncState, pending: number, connected: boolean) { return state === "loading" ? "Открываем…" : !connected ? "Только на устройстве" : state === "syncing" ? "Синхронизируем…" : state === "error" ? "Ошибка синхронизации" : state === "offline" ? "Нет интернета" : pending ? `Ждут отправки: ${pending}` : "Рецепты синхронизированы"; }
