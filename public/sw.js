...
function safeYandexDownloadUrl(value) {
  try {
    const url = new URL(value);
    return url.protocol === "https:" && (url.hostname === "downloader.disk.yandex.ru" || url.hostname.endsWith(".storage.yandex.net")) ? url.toString() : null;
  } catch {
    return null;
  }
}
